                  ...
                  <div className="mt-4 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    {packages.map((pkg) => {
                      ...
                      return (
                        <div
                          key={pkg.name}
                          className={`rounded-lg p-6 flex flex-col h-full bg-white ring-1 transition-all duration-300 ease-in-out
                          ${isCurrentPlan 
                            ? 'opacity-50 ring-gray-200' 
                            : 'ring-gray-200 hover:ring-2 hover:ring-blue-400 hover:shadow-lg hover:-translate-y-1'
                          }`}
                        >
                          ...
                          <button
                            ...
                            className={`mt-8 w-full rounded-lg px-3.5 py-2.5 text-center text-sm font-semibold shadow-sm 
                            focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-all duration-300 ease-in-out
                            ${isCurrentPlan
                              ? 'bg-gray-300 cursor-not-allowed'
                              : 'bg-gradient-to-r from-blue-600 to-blue-500 text-white hover:from-blue-700 hover:to-blue-600 hover:shadow-md active:scale-[0.98] active:shadow-none focus-visible:outline-blue-600'
                            }`}
                          >
                            {isLoading ? (
