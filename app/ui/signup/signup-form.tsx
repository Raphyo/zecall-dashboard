      ...
      <div className="relative max-w-md w-full backdrop-blur-sm bg-white/80 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] space-y-8 p-8 border border-white/20 mx-4">
        <div className="text-center space-y-2">
          ...
          <p className="text-gray-600">
            Créez un compte en quelques secondes et économisez des milliers d'heures au téléphone.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative group">
                <input
                  ...
                  required
                />
                <UserIcon className="pointer-events-none absolute right-4 top-1/2 h-5 w-5 -translate-y-1/2 text-gray-400 group-focus-within:text-purple-500 transition-colors duration-200" />
              </div>
            </div>
